...
class OnboardingManager {
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        ...
        let welcomeScreenStep = WelcomeScreenStep(transformer: discoveryConfigurationTransformer, providers: [DiscoveryServiceConfigurationProvider(applicationID: "com.sap.expense")])
