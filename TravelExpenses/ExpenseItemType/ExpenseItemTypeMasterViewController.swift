//
// ExpenseItemTypeMasterViewController.swift
// TravelExpenses
//
...
class ExpenseItemTypeMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    private let appDelegate = UIApplication.shared.delegate as! AppDelegate
    private var travelexpense: Travelexpense<OfflineODataProvider> {
        return self.appDelegate.travelexpense
    }

    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([ExpenseItemType]?, Error?) -> Void) -> Void)?
    private var entities: [ExpenseItemType] = [ExpenseItemType]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let expenseitemtype = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "REPORTID", value: "\(expenseitemtype.reportid!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ExpenseItemTypeDetailViewController
...
extension ExpenseItemTypeMasterViewController: EntitySetUpdaterDelegate {
